...
/local1/home/pazweifel/bin/ldsc/ldsc.py \
  --h2-cts /local1/scratch/pazweifel/heritability_analysis/ldsc_correlation_bipolar/sumstats/bip2024_eur_clinical_no23andMe_wbeta_use_neff.sumstats.gz \
  ...
  --out /local1/home/pazweifel/src/bipolar_bias/Clinical_sldsc.h2 \
  --samp-prev 0.5 \
  --pop-prev 0.02
