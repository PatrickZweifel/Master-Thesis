...
sldsc_traits <- c("Clin", "Comm", "Neu")

output_path <- "S_LDSC_community_liability_Neu.RData"
samples_comm_neu <- c(samples[1:2], "/local1/scratch/pazweifel/sumstats_ambits/munged/Neu.sumstats.gz")
