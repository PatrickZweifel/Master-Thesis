...
#### 1. Load data
#### -------------------------
prs_file <- "/local1/scratch/pazweifel/PRS/jolien_common_factor/score.all_score"
...
results_dt
write.csv(results_dt, file = "/local1/scratch/pazweifel/PRS/jolien_common_factor/R_squared_ukbb.csv")
print("Done!")