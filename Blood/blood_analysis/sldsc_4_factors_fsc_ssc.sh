...
for file in /local1/scratch/pazweifel/sumstats_blood/factor_sumstats/*.tsv; do
 #extract filename
        ...
        /local1/home/pazweifel/bin/ldsc/munge_sumstats.py \
                ...
                --N-col N \
                --out /local1/scratch/pazweifel/sumstats_blood/munged_factor_sumstats/$filename

        /local1/home/pazweifel/bin/ldsc/ldsc.py \
                --h2-cts /local1/scratch/pazweifel/sumstats_blood/munged_factor_sumstats/${filename}.sumstats.gz \
